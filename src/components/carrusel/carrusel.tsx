      ...
      <SwiperSlide>
        <div className="bg-gradient-to-r from-purple-300 to-blue-300 p-6 text-white text-center">
          ...
          <p className="text-lg mb-4">
            Snacks, juguetes y más para perros y gatos
          </p>
          <div className="flex justify-center space-x-4 mb-4">
            <span className="bg-white text-purple-700 px-4 py-2 rounded-full">
              Juguetes
            </span>
            <span className="bg-white text-purple-700 px-4 py-2 rounded-full">
              Correas
      ...
      <SwiperSlide>
        ...
        <div className="bg-gradient-to-r from-yellow-100 to-yellow-400 p-6 text-center">
          <h2 className="text-3xl font-bold text-yellow-800">
            ¡Oferta especial Hills!
          </h2>
          <p className="text-5xl font-extrabold text-red-600 my-2">30% OFF</p>
          <p className="text-lg text-yellow-900 mb-4">
            Nutrición premium para tu mascota con descuento
          </p>
          <div className="flex justify-center gap-4">
            <Image
              width={100}
              height={100}
              src="/images/tienda/Productos/Alimento/Alimento2.png"
              alt="Hills comida"
            ...
            <Image
              width={100}
              height={100}
              src="/images/tienda/Productos/Alimento/AlimentoCat5.png"
              alt="Hills comida"
              className="h-32 rounded-lg shadow-md"
            />
          </div>
